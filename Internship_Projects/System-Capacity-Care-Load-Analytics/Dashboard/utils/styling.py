"""
Theme engine + reusable UI pieces for the UAC care-capacity dashboard.
...
def sidebar_brand():
    ...
    st.sidebar.markdown(
        ...
        <div class="brand-row">
            ...
            <div>
                <div class="brand-title">UAC Care Capacity</div>
                <div class="brand-sub">System Load Analytics</div>
            </div>
        </div>
...
def sidebar_footer():
    ...
    if st.sidebar.button(label, use_container_width=True, key="theme_toggle_btn"):
        ...
        st.rerun()
    st.sidebar.markdown(
        "<div class='brand-sub' style='text-align:center; margin-top:6px;'>HHS UAC Program Analytics<br>Data-driven capacity monitoring</div>",
        unsafe_allow_html=True,
    )
